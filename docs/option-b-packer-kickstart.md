...
variable "iso_url" {
  type    = string
  default = "https://dl.aegisgroup.ch/rocky/9/isos/x86_64/Rocky-9-latest-x86_64-minimal.iso"
}
...
oras push harbor.aegisgroup.ch/library/rocky9-cis-golden:$(date +%Y%m%d) \
...
spec:
  ...
  sourceType: download
  url: "https://harbor.aegisgroup.ch/v2/library/rocky9-cis-golden/blobs/<digest>"
...
upload-to-harbor:
  stage: upload
  script:
    - oras push harbor.aegisgroup.ch/library/rocky9-cis-golden:${CI_PIPELINE_ID} output/rocky9-cis-golden.qcow2:application/octet-stream
  ...
  script:
    - |
      ...
      spec:
        ...
        sourceType: download
        url: "https://harbor.aegisgroup.ch/v2/library/rocky9-cis-golden/blobs/sha256:TODO"
      EOF
```
