...
[![CI](https://github.com/derhornspieler/harvester-golden-image/actions/workflows/ci.yml/badge.svg)](https://github.com/derhornspieler/harvester-golden-image/actions/workflows/ci.yml)
...
```bash
# Clone and configure
git clone https://github.com/derhornspieler/harvester-golden-image.git
